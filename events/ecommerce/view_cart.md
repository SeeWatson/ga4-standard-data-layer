...
Fired when a user views the items in their cart. This can include "quick view" popups as well as full cart page visits.
...
|value|number|recommended|The monetary value of the event.|7.77|^\d\.\d\d$||